...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('landing-pages/assets/css/bootstrap.min.css') }}">

    <link rel="stylesheet" type="text/css" href="{{ asset('landing-pages/assets/css/font-awesome.css') }}">

    <link rel="stylesheet" type="text/css" href="{{ asset('landing-pages/assets/css/templatemo-art-factory.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('landing-pages/assets/css/owl-carousel.css') }}">
...
<body>
                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            {{-- <li class="scroll-to-section"><a href="/pengguna_air">Login</a></li> --}}
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"
                        ...
                        <img src="{{ asset('landing-pages/assets/images/slider-icon.png') }}"
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7 col-md-12 col-sm-12"
                    data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
                    <img src="{{ asset('landing-pages/assets/images/left-image.png') }}"
        ...
        <div class="container">
            <div class="row">
                <div class="left-text col-lg-5 col-md-12 col-sm-12 mobile-bottom-fix">
                    ...
                    <ul>
                        <li>
                            <img src="{{ asset('landing-pages/assets/images/about-icon-01.png') }}" alt="">
                            <div class="text">
                        ...
                        <li>
                            <img src="{{ asset('landing-pages/assets/images/about-icon-02.png') }}" alt="">
                            <div class="text">
                        ...
                        <li>
                            <img src="{{ asset('landing-pages/assets/images/about-icon-03.png') }}" alt="">
                            <div class="text">
                ...
                <div class="right-image col-lg-7 col-md-12 col-sm-12 mobile-bottom-fix-big"
                    data-scroll-reveal="enter right move 30px over 0.6s after 0.4s">
                    <img src="{{ asset('landing-pages/assets/images/right-image.png') }}"
                        class="rounded img-fluid d-block mx-auto" alt="App">
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="owl-carousel owl-theme">
                    <div class="item service-item">
                        <div class="icon">
                            <i><img src="{{ asset('landing-pages/assets/images/service-icon-01.png') }}" alt=""></i>
                        </div>
                    ...
                    <div class="item service-item">
                        <div class="icon">
                            <i><img src="{{ asset('landing-pages/assets/images/service-icon-02.png') }}" alt=""></i>
                        </div>
                    ...
                    <div class="item service-item">
                        <div class="icon">
                            <i><img src="{{ asset('landing-pages/assets/images/service-icon-03.png') }}" alt=""></i>
                        </div>
    ...
    <!-- jQuery -->
    <script src="{{ asset('landing-pages/assets/js/jquery-2.1.0.min.js') }}"></script>

    <!-- Bootstrap -->
    <script src="{{ asset('landing-pages/assets/js/popper.js') }}"></script>
    <script src="{{ asset('landing-pages/assets/js/bootstrap.min.js') }}"></script>

    <!-- Plugins -->
    <script src="{{ asset('landing-pages/assets/js/owl-carousel.js') }}"></script>
    <script src="{{ asset('landing-pages/assets/js/scrollreveal.min.js') }}"></script>
    <script src="{{ asset('landing-pages/assets/js/waypoints.min.js') }}"></script>
    <script src="{{ asset('landing-pages/assets/js/jquery.counterup.min.js') }}"></script>
    <script src="{{ asset('landing-pages/assets/js/imgfix.min.js') }}"></script>

    <!-- Global Init -->
    <script src="{{ asset('landing-pages/assets/js/custom.js') }}"></script>
