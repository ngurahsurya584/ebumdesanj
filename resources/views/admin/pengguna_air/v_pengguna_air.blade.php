...
@section('content')
    ...
    <div class="content">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class=" btn btn-danger btn-xs" data-toggle="modal"
                                                    data-target="#hapus{{ $pa->id_pengguna_air }}">
        ...
        @foreach ($pengguna_air as $pa)
            <div class="modal  fade mt-5" id="hapus{{ $pa->id_pengguna_air }}" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog " role="document">
                    <div class="modal-content ">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="/pengguna/delete/{{ $pa->id_pengguna_air }}" class="btn btn-primary">Yes</a>
