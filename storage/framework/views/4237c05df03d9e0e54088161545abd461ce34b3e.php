    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="number" class="form-control input-square" id="edit_r_a_awal" name="r_a_awal"
                value="<?php echo e($data_tarif->r_a_awal); ?>" placeholder="Meteran Awal">
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="number" class="form-control input-square" id="edit_r_a_akhir" name="r_a_akhir"
                value="<?php echo e($data_tarif->r_a_akhir); ?>" placeholder="Meteran Akhir">
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="number" class="form-control input-square" id="edit_r_a_biaya" name="r_a_biaya"
                value="<?php echo e($data_tarif->r_a_biaya); ?>" placeholder="Biaya ">
        </div>
    </div>
</div>
<div class="row">
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="number" class="form-control input-square" id="edit_r_b_awal" name="r_b_awal"
                value="<?php echo e($data_tarif->r_b_awal); ?>" placeholder="Meteran Awal">
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="number" class="form-control input-square" id="edit_r_b_akhir" name="r_b_akhir"
                value="<?php echo e($data_tarif->r_b_akhir); ?>" placeholder="Meteran Akhir">
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="number" class="form-control input-square" id="edit_r_b_biaya" name="r_b_biaya"
                value="<?php echo e($data_tarif->r_b_biaya); ?>" placeholder="Biaya">
        </div>
    </div>
</div>
<div class="row">
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="number" class="form-control input-square" id="edit_r_c_awal" name="r_c_awal"
                value="<?php echo e($data_tarif->r_c_awal); ?>" placeholder="Meteran Awal">
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="number" class="form-control input-square" id="edit_r_c_akhir" name="r_c_akhir"
                value="<?php echo e($data_tarif->r_c_akhir); ?>" placeholder="Meteran Akhir">
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="number" class="form-control input-square" id="edit_r_c_biaya" name="r_c_biaya"
                value="<?php echo e($data_tarif->r_c_biaya); ?>" placeholder="Biaya">
        </div>
    </div>
</div>
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="number" class="form-control input-square" id="edit_biaya_admin" name="biaya_admin"
                value="<?php echo e($data_tarif->biaya_admin); ?>" placeholder="Meteran Awal">
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="number" class="form-control input-square" id="edit_biaya_service" name="biaya_service"
                value="<?php echo e($data_tarif->biaya_service); ?>" placeholder="Meteran Akhir">
        </div>
    </div>
...
<div class="modal-footer">
    ...
    <button class="btn btn-primary" onclick="update(<?php echo e($data_tarif->id_tarif); ?>)"><i class="fas fa-save mr-2"></i>
        Perbarui
    </button>
</div>
<?php /**PATH D:\UndikshaNgurah\xampp\htdocs\newEbumdesUAS\resources\views/admin/tarif_air/e_tarif_air.blade.php ENDPATH**/ ?>