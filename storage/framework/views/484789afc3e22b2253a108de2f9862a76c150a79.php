...
<head>
    ...
    <title>E-Bumdes Kencana Sari Merta </title>

    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('landing-pages/assets/css/bootstrap.min.css')); ?>">

    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('landing-pages/assets/css/font-awesome.css')); ?>">

    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('landing-pages/assets/css/templatemo-art-factory.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('landing-pages/assets/css/owl-carousel.css')); ?>">
...
<body>
            ...
            <div class="container">
                <div class="row">
                    <div class="left-text col-lg-6 col-md-6 col-sm-12 col-xs-12"
                        ...
                        <h1>Selamat Datang di <strong>BUMDES</strong></h1>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"
                        ...
                        <img src="<?php echo e(asset('landing-pages/assets/images/slider-icon.png')); ?>"
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7 col-md-12 col-sm-12"
                    data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
                    <img src="<?php echo e(asset('landing-pages/assets/images/left-image.png')); ?>"
                ...
                <div class="right-text col-lg-5 col-md-12 col-sm-12 mobile-top-fix">
                    ...
                    <div class="left-text">
                        <p>This template is <a href="#">last updated on 20 August 2019 </a>for main menu drop-down arrow
                            ...
                            nisl sit amet tristique condimentum. <br><br> Sed a consequat velit. Morbi lectus sapien,
                            vestibulum et sapien sit amet, ultrices malesuada odio. Donec non quam euismod, mattis dui
                            a, ultrices nisi.</p>
        ...
        <div class="container">
            <div class="row">
                <div class="left-text col-lg-5 col-md-12 col-sm-12 mobile-bottom-fix">
                    ...
                    <ul>
                        <li>
                            <img src="<?php echo e(asset('landing-pages/assets/images/about-icon-01.png')); ?>" alt="">
                            <div class="text">
                        ...
                        <li>
                            <img src="<?php echo e(asset('landing-pages/assets/images/about-icon-02.png')); ?>" alt="">
                            <div class="text">
                        ...
                        <li>
                            <img src="<?php echo e(asset('landing-pages/assets/images/about-icon-03.png')); ?>" alt="">
                            <div class="text">
                ...
                <div class="right-image col-lg-7 col-md-12 col-sm-12 mobile-bottom-fix-big"
                    data-scroll-reveal="enter right move 30px over 0.6s after 0.4s">
                    <img src="<?php echo e(asset('landing-pages/assets/images/right-image.png')); ?>"
                        class="rounded img-fluid d-block mx-auto" alt="App">
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="owl-carousel owl-theme">
                    <div class="item service-item">
                        <div class="icon">
                            <i><img src="<?php echo e(asset('landing-pages/assets/images/service-icon-01.png')); ?>" alt=""></i>
                        </div>
                    ...
                    <div class="item service-item">
                        <div class="icon">
                            <i><img src="<?php echo e(asset('landing-pages/assets/images/service-icon-02.png')); ?>" alt=""></i>
                        </div>
                    ...
                    <div class="item service-item">
                        <div class="icon">
                            <i><img src="<?php echo e(asset('landing-pages/assets/images/service-icon-03.png')); ?>" alt=""></i>
                        </div>
                ...
                <div class="left-text col-lg-6 col-md-6 col-sm-12">
                    ...
                    <div class="accordion-text">
                        <p>Curabitur placerat diam in risus lobortis, laoreet porttitor est elementum. Nulla ultricies
                            ...
                            iaculis. Aenean bibendum erat vitae odio sodales,
                            ...
                            <div class="accordion-body">
                                <div class="content">
                                    <p>Duis vulputate porttitor urna sit amet pretium. Phasellus sed pulvinar eros,
                                        ...
                                        <br><br> Pellentesque maximus lorem sed elit imperdiet mattis. Duis posuere
                            ...
                            <div class="accordion-body">
                                <div class="content">
                                    <p>Sed odio elit, cursus sed consequat at, rutrum eget augue. Cras ac eros iaculis,
                                        ...
                                        <br><br> Praesent ut placerat turpis, vel pellentesque dolor. Sed rutrum
                                        eleifend tortor, eu luctus orci sagittis in. In blandit fringilla mollis.
                                    </p>
                                </div>
                            </div>
                        </article>
                            ...
                            <div class="accordion-body">
                                <div class="content">
                                    <p>Proin feugiat ante ut vulputate rutrum. Nam quis erat turpis. Nullam maximus
                                        ...
                                        dignissim.
                                        <br><br> Etiam et enim finibus, feugiat massa efficitur, finibus sapien. Sed
                                        cursus lacus quis arcu scelerisque, eget ornare risus maximus. Aenean non lectus
                                        id odio rhoncus pharetra.
                                    </p>
                                </div>
                            </div>
                        </article>
                            ...
                            <div class="accordion-body">
                                <div class="content">
                                    <p>Phasellus eu purus ornare, eleifend orci nec, egestas nulla. Sed sed aliquet
                                        ...
                                        <br><br> Aenean fermentum eget turpis egestas semper. Sed finibus mollis
                            ...
                            <div class="accordion-body">
                                <div class="content">
                                    <p>Quisque aliquet ipsum ut magna rhoncus, euismod lacinia elit rhoncus. Sed sapien
                                        ...
                                        <br><br> Sed nec ex nec tortor fermentum sollicitudin id ut ligula. Ut sagittis
                                        rutrum lectus, non sagittis ante euismod eu.
                                    </p>
                                </div>
                            </div>
                        </article>
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-lg-7 col-md-12 col-sm-12">
                    <p class="copyright">Copyright &copy; 2020 Art Factory Company . Design: <a rel="nofollow"
    ...
    <!-- jQuery -->
    <script src="<?php echo e(asset('landing-pages/assets/js/jquery-2.1.0.min.js')); ?>"></script>

    <!-- Bootstrap -->
    <script src="<?php echo e(asset('landing-pages/assets/js/popper.js')); ?>"></script>
    <script src="<?php echo e(asset('landing-pages/assets/js/bootstrap.min.js')); ?>"></script>

    <!-- Plugins -->
    <script src="<?php echo e(asset('landing-pages/assets/js/owl-carousel.js')); ?>"></script>
    <script src="<?php echo e(asset('landing-pages/assets/js/scrollreveal.min.js')); ?>"></script>
    <script src="<?php echo e(asset('landing-pages/assets/js/waypoints.min.js')); ?>"></script>
    <script src="<?php echo e(asset('landing-pages/assets/js/jquery.counterup.min.js')); ?>"></script>
    <script src="<?php echo e(asset('landing-pages/assets/js/imgfix.min.js')); ?>"></script>

    <!-- Global Init -->
    <script src="<?php echo e(asset('landing-pages/assets/js/custom.js')); ?>"></script>

</body>

</html>
<?php /**PATH D:\UndikshaNgurah\xampp\htdocs\newEbumdesUAS\resources\views/layouts/front-end/fh.blade.php ENDPATH**/ ?>